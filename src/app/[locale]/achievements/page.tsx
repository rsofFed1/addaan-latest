                                                            ...
                                                            >
                                                                {item.images.map((img, imgIdx) => (
                                                                    <SwiperSlide key={String(imgIdx) + img}>
                                                                        <div className="group relative rounded-2xl overflow-hidden shadow-md h-[300px] md:h-full w-full">
                                                                            <Image
                                                                                src={img}
                                                                                alt={t(item.titleKey)}
                                                                                fill
                                                                                className="object-cover w-full h-full group-hover:scale-105 transition-transform duration-500"
                                                                                // only mark highest-priority first image of first item as priority
