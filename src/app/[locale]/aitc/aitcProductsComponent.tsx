...
import { AitcCoreTraysProductsData } from "@/constant/SuppliersProductsData/AitcCoreTrays"
...
export const AITCProductsComponent = ({ showHeader = true }: { showHeader: boolean }) => {
    const [expandedCategory, setExpandedCategory] = useState<string | null>("aitc-core-trays")
                        ...
                        <div className="max-w-[1400px] mx-auto px-4 z-10 relative">
                            <div className="text-center">
                                <div className="inline-flex items-center justify-center mb-6">
                                    ...
                                    <span className="text-white font-semibold uppercase tracking-wider text-sm"> {t('Products.aitcCoreTrays.title')} </span>
                                    <div className="w-12 h-1 bg-[#13A7DC] m-4" />
                                </div>
                                <h2 className="text-4xl md:text-5xl font-bold text-white mb-6"> {t('Products.aitcCoreTrays.heading')} </h2>
                                <p className="text-lg text-gray-200 max-w-2xl mx-auto leading-relaxed"> {t('Products.aitcCoreTrays.description')} </p>
                            </div>
                        </div>
                    </section>
                )}
                <section id="products" className="py-20 relative overflow-hidden" style={{ backgroundImage: "url('/images/artwork/artwork-7.webp')", backgroundSize: 'cover', backgroundPosition: 'center', backgroundColor: 'rgba(0, 0, 0, 0.8)', backgroundBlendMode: 'multiply' }}  >
                    <div className="max-w-[1400px] mx-auto px-4 relative z-10">
                        <div className="space-y-6 max-w-[1400px] mx-auto">
                            {AitcCoreTraysProductsData.map((category) => (
                                <div
                                    key={category.id}
