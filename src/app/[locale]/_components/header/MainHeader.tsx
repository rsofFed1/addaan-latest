...
export default function MainHeader() {
    ...
    return (
        <header className="bg-[#222222] fixed inset-x-0 z-50 shadow-md">
            <div className="max-w-[1400px] mx-auto px-6 md:h-28 h-20 flex items-center justify-between text-white">
                <div className="flex flex-row gap-4 md:gap-10 items-center z-100">
                    <button
                    ...
                    >
                        {!mobileOpen ? (
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30" fill="white" aria-hidden>
                        ...
                        <ul className="flex items-center gap-8">
                            {navItems.map((item) => (
                                <li key={item.href}>
                                    <Link
                                        href={item.href}
                                        className="uppercase tracking-wide text-sm font-semibold text-white transition-all duration-200 hover:text-[#13A7DC] relative after:absolute after:bottom-[-4px] after:left-0 after:w-0 after:h-[0.3px] after:bg-[#13A7DC] after:transition-all after:duration-400 hover:after:w-full"
                                    >
                                        {item.label}
                                    </Link>
                                </li>
            ...
            <motion.div
                ...
                className="lg:hidden overflow-hidden bg-[#222222] text-white backdrop-blur-sm absolute top-0 w-full z-50"
            >
